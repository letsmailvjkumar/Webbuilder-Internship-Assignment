  ...
  return (
    <div className="mt-10">
      <div className=" flex flex-col gap-10">
        ...
        <div className="w-8 h-8 border rounded-full text-center absolute left-[-20px] bg-white top-7">
          1
        </div>
          <div className="flex absolute bottom-52 bg-[rgb(255,119,36)] w-32 p-1 rounded-lg items-center text-white">
            <div className="">
          ...
          <div className="flex">
            ...
            <div className="ms-20 mt-10 flex flex-col gap-2">
              ...
              <div className="flex cursor-pointer text-[rgb(27,136,244)] mb-5 w-fit">
                Show more
                <img src={down} alt="" />
              </div>
            </div>
            <div>
              <div className="flex flex-col items-center gap-3 bg-[rgb(243,249,255)] p-2 me-10 ">
              ...
              <div>
                <button className="bg-[rgb(27,136,244)] w-36  mt-16 me-10 text-white p-2 rounded-lg">
                  View
                </button>
              </div>
            </div>
        ...
        <div className="w-8 h-8 border rounded-full text-center absolute left-[-20px] bg-white top-7">
          ...
          <div className="flex">
            ...
            <div>
              ...
              <div>
                <button className="bg-[rgb(27,136,244)] w-36  mt-64 me-10 text-white p-2 rounded-lg">
                  View
                </button>
              </div>
            </div>
